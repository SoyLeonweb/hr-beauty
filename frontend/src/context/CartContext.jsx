...
const SHIPPING_THRESHOLD = 50000    // envío gratis sobre este valor
const SHIPPING_COST      = 8000     // costo de envío estándar
...
export function CartProvider({ children }) {
  ...
  const iva      = Math.round(subtotalConDescuento * IVA_RATE)
  ...
  const total = subtotalConDescuento + iva + shipping
  ...
  return (
    <CartContext.Provider value={{
      ...
      subtotal, discount, iva, shipping, shippingFree, total, count,
      SHIPPING_THRESHOLD, SHIPPING_COST, IVA_RATE,
    }}>
      {children}
